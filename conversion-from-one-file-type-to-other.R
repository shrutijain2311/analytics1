...
read1 = read.csv(file="./data/shruti.csv", header = TRUE,sep = ",")
str(read1)
class(read1)
head(read1)
...
head(df_gsheet)
#my sheet in google(not working)
url2="https://docs.google.com/spreadsheets/d/1gt_3ZxvEPSw9yRXeA-VGF3OyC-GlyHVPnWsUSgil4Tw/edit#gid=0"
xyz.coords()=as.data.frame(gsheet2tbl(url12))
head(xyz)
#
#Excel----
